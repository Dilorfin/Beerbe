...
$output_path = Join-Path -Path $data_path -ChildPath "game-x32"
...
$love_url=((Invoke-WebRequest -URI 'https://api.github.com/repos/love2d/love/releases/latest' | ConvertFrom-Json).assets | Where-Object { $_.name -like "love-*-win32.zip" }).browser_download_url
Write-Host "love url: $($love_url)"
Invoke-WebRequest -Uri $love_url -OutFile "./love2d-x32.zip"
Expand-Archive -LiteralPath "./love2d-x32.zip" -DestinationPath "."
...
cd $project_dir
Remove-Item -LiteralPath "./love2d-x32.zip" -Force
